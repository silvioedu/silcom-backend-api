...
(2, 1, 1, 0, 0, 200, true, 'Observação venda do cliente 1/2', now() at time zone 'utc', now() at time zone 'utc'),
(3, 1, 1, 0, 0, 200, false, 'Observação venda do cliente 1/3', now() at time zone 'utc', now() at time zone 'utc'),
(4, 2, 1, 0, 0, 200, true, 'Observação venda do cliente 2/1', now() at time zone 'utc', now() at time zone 'utc'),
(5, 3, 1, 0, 0, 200, false, 'Observação venda do cliente 3/1', now() at time zone 'utc', now() at time zone 'utc'),
(6, 3, 1, 0, 0, 200, true, 'Observação venda do cliente 3/1', now() at time zone 'utc', now() at time zone 'utc');
