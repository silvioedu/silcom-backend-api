...
class FormaPagamentoTipoControllerIT {
    ...
    void shouldReturn200_whenReceiveGET_withValidInput() {
        RestAssured
            ...
            .then()
                ...
                .body("id", equalTo(1))
                .body("nome", containsString("À vista"))
                .body("desconto", equalTo(10F))
                .body("agravo", equalTo(0F))
    ...
    @Test
    void shouldReturn400_whenReceivePUT_withInvalidInput() {
        FormaPagamentoTipoInputDTO input = FormaPagamentoTipoMock.getInputInstance();
        input.setNome("");
