...
class LembreteTipoControllerIT {
	...
	void setUp() {
		...
		RestAssured.basePath = "/cadastros/lembretes-tipos";
    ...
    void shouldReturn200_whenReceiveGET_withValidInput() {
        RestAssured
            ...
            .then()
                ...
                .body("id", equalTo(1))
                .body("nome", containsString("Próximo contato"))
                .body("intervalo", equalTo(7))
    ...
    void shouldReturn201_WhenReceivePOST_withValidInput() {
        ...
        RestAssured
            ...
            .then()
                ...
                .body("intervalo", equalTo(input.getIntervalo()))
                .body("$", hasKey("id"))
                .body("$", hasKey("dataCriacao"))
                .body("$", hasKey("dataAtualizacao"));
    }
